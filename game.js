...
document.getElementById("dev-btn").onclick = () => {
  hideAll();
  screens.dev.classList.remove("hidden");
};


document.getElementById("dev-fireworks").onclick = () => {
  stars += 10000;
  alert("🎆 Gave 10,000 Fireworks!");
  saveAll();
};


document.getElementById("dev-skip").onclick = () => {
  enemies = [];
  alert("⏭️ Wave skipped!");
};
